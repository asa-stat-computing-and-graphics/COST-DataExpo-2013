...
d.08<- read.csv('http://stat-computing.org/dataexpo/2013/data/sotc-08.csv', header=T)
d.09<- read.csv('http://stat-computing.org/dataexpo/2013/data/sotc-09.csv', header=T)
d.10<- read.csv('http://stat-computing.org/dataexpo/2013/data/sotc-10.csv', header=T)
